...
class ResultClass:
    def __init__(self,root):
        ...
        lbl_course=Label(self.root,text="Courses",font=("goudy old style",15,"bold"),bg='white').place(x=50,y=220)
        ...
        self.lbl_img=Label(self.root,image=self.bg_img).place(x=650,y=100)
    #=================================================
    def fetch_roll(self):
